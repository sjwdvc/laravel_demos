...
if (function (e, t) {
    ...
    var n = [], i = e.document, o = n.slice, r = n.concat, s = n.push, a = n.indexOf, l = {}, c = l.toString,
        u = l.hasOwnProperty, d = {}, p = function (e, t) {
            return new p.fn.init(e, t)
        }, h = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, f = /^-ms-/, g = /-([\da-z])/gi, m = function (e, t) {
    ...
    p.fn = p.prototype = {
        jquery: "2.2.4", constructor: p, selector: "", length: 0, toArray: function () {
            return o.call(this)
        }, get: function (e) {
        ...
        for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || p.isFunction(s) || (s = {}), a === l && (s = this, a--); l > a; a++) if (null != (e = arguments[a])) for (t in e) n = s[t], i = e[t], s !== i && (c && i && (p.isPlainObject(i) || (o = p.isArray(i))) ? (o ? (o = !1, r = n && p.isArray(n) ? n : []) : r = n && p.isPlainObject(n) ? n : {}, s[t] = p.extend(c, r, i)) : void 0 !== i && (s[t] = i));
        return s
    }, p.extend({
        expando: "jQuery" + ("2.2.4" + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
            ...
            var n, i = 0;
            if (v(e)) for (n = e.length; n > i && !1 !== t.call(e[i], i, e[i]); i++) ; else for (i in e) if (!1 === t.call(e[i], i, e[i])) break;
            return e
        }, trim: function (e) {
            ...
            var i, o, s = 0, a = [];
            if (v(e)) for (i = e.length; i > s; s++) o = t(e[s], s, n), null != o && a.push(o); else for (s in e) o = t(e[s], s, n), null != o && a.push(o);
            return r.apply([], a)
    ...
    var y = function (e) {
        var t, n, i, o, r, s, a, l, c, u, d, p, h, f, g, m, v, y, b, x = "sizzle" + 1 * new Date, w = e.document, C = 0,
            k = 0, T = re(), j = re(), E = re(), S = function (e, t) {
                return e === t && (d = !0), 0
            }, A = 1 << 31, N = {}.hasOwnProperty, $ = [], D = $.pop, O = $.push, I = $.push, Q = $.slice,
            H = function (e, t) {
            ...
            _ = "\\[" + L + "*(" + P + ")(?:" + L + "*([*^$|!~]?=)" + L + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + P + "))|)" + L + "*\\]",
            q = ":(" + P + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + _ + ")*)|.*)\\)|)",
            F = new RegExp(L + "+", "g"), M = new RegExp("^" + L + "+|((?:^|[^\\\\])(?:\\\\.)*)" + L + "+$", "g"),
            W = new RegExp("^" + L + "*," + L + "*"), B = new RegExp("^" + L + "*([>+~]|" + L + ")" + L + "*"),
            U = new RegExp("=" + L + "*([^\\]'\"]*?)" + L + "*\\]", "g"), z = new RegExp(q),
            V = new RegExp("^" + P + "$"), Y = {
                ID: new RegExp("^#(" + P + ")"),
                CLASS: new RegExp("^\\.(" + P + ")"),
                TAG: new RegExp("^(" + P + "|[*])"),
        ...
        function oe(e, t, i, o) {
            ...
            if (!o && ((t ? t.ownerDocument || t : w) !== h && p(t), t = t || h, g)) {
                ...
                if (n.qsa && !E[e + " "] && (!m || !m.test(e))) {
                    if (1 !== k) C = t, y = e; else if ("object" !== t.nodeName.toLowerCase()) {
            ...
            filter: {
                TAG: function (e) {
                    ...
                    return 1 === i && 0 === o ? function (e) {
                        ...
                        var c, u, d, p, h, f, g = r !== s ? "nextSibling" : "previousSibling", m = t.parentNode,
                        ...
                        if (m) {
                            ...
                            if (f = [s ? m.firstChild : m.lastChild], s && y) {
                                for (b = (h = (c = (u = (d = (p = m)[x] || (p[x] = {}))[p.uniqueID] || (d[p.uniqueID] = {}))[e] || [])[0] === C && c[1]) && c[2], p = h && m.childNodes[h]; p = ++h && p && p[g] || (b = h = 0) || f.pop();) if (1 === p.nodeType && ++b && p === t) {
                                    u[e] = [C, h, b];
                                    break
                                }
                            } else if (y && (p = t, d = p[x] || (p[x] = {}), u = d[p.uniqueID] || (d[p.uniqueID] = {}), c = u[e] || [], h = c[0] === C && c[1], b = h), !1 === b) for (; (p = ++h && p && p[g] || (b = h = 0) || f.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++b || (y && (d = p[x] || (p[x] = {}), u = d[p.uniqueID] || (d[p.uniqueID] = {}), u[e] = [C, b]), p !== t));) ;
        ...
        function be(e, t, n, i, o, r) {
            return i && !i[x] && (i = be(i)), o && !o[x] && (o = be(o, r)), se(function (r, s, a, l) {
                var c, u, d, p = [], h = [], f = s.length, g = r || function (e, t, n) {
                        for (var i = 0, o = t.length; o > i; i++) oe(e, t[i], n);
                        return n
                    }(t || "*", a.nodeType ? [a] : a, []), m = !e || !r && t ? g : ye(g, p, e, a, l),
                    v = n ? o || (r ? e : f || i) ? [] : s : m;
                if (n && n(m, v, a, l), i) for (c = ye(v, h), i(c, [], a, l), u = c.length; u--;) (d = c[u]) && (v[h[u]] = !(m[h[u]] = d));
                if (r) {
                    if (o || e) {
                        if (o) {
        ...
        function xe(e) {
            for (var t, n, o, r = e.length, s = i.relative[e[0].type], a = s || i.relative[" "], l = s ? 1 : 0, u = me(function (e) {
                ...
                return t = null, o
            }]; r > l; l++) if (n = i.relative[e[l].type]) p = [me(ve(p), n)]; else {
                if ((n = i.filter[e[l].type].apply(null, e[l].matches))[x]) {
                    for (o = ++l; r > o && !i.relative[e[o].type]; o++) ;
                    return be(l > 1 && ve(p), l > 1 && ge(e.slice(0, l - 1).concat({value: " " === e[l - 2].type ? "*" : ""})).replace(M, "$1"), n, o > l && xe(e.slice(l, o)), r > o && xe(e = e.slice(o)), r > o && ge(e))
                }
                p.push(n)
            }
            return ve(p)
        ...
        return fe.prototype = i.filters = i.pseudos, i.setFilters = new fe, s = oe.tokenize = function (e, t) {
            ...
            var n, o, r, a, l, u, d = [], f = [], m = E[e + " "];
            if (!m) {
                for (t || (t = s(e)), n = t.length; n--;) m = xe(t[n]), m[x] ? d.push(m) : f.push(m);
                (m = E(e, (o = f, a = (r = d).length > 0, l = o.length > 0, u = function (e, t, n, s, u) {
                    var d, f, m, v = 0, y = "0", b = e && [], x = [], w = c, k = e || l && i.find.TAG("*", u),
                        T = C += null == w ? 1 : Math.random() || .1, j = k.length;
                    for (u && (c = t === h || t || u); y !== j && null != (d = k[y]); y++) {
                        if (l && d) {
                            for (f = 0, t || d.ownerDocument === h || (p(d), n = !g); m = o[f++];) if (m(d, t || h, n)) {
                                s.push(d);
                                break
                            }
                            u && (C = T)
                    ...
                    if (v += y, a && y !== v) {
                        ...
                        if (e) {
                            if (v > 0) for (; y--;) b[y] || x[y] || (x[y] = D.call(s));
                            x = ye(x)
                        }
            ...
            var l, c, u, d, p, h = "function" == typeof e && e, f = !r && s(e = h.selector || e);
            if (o = o || [], 1 === f.length) {
                ...
                for (l = Y.needsContext.test(e) ? 0 : c.length; l-- && (u = c[l], !i.relative[d = u.type]);) if ((p = i.find[d]) && (r = p(u.matches[0].replace(te, ne), Z.test(c[0].type) && he(t.parentNode) || t))) {
    ...
    var b = function (e, t, n) {
        ...
        return n
    }, w = p.expr.match.needsContext, C = /^<([\w-]+)\s*\/?>(?:<\/\1>|)$/, k = /^.[^:#\[\.,]*$/;
    ...
    (p.fn.init = function (e, t, n) {
        ...
        if (n = n || j, "string" == typeof e) {
            ...
            if (o[1]) {
                if (t = t instanceof p ? t[0] : t, p.merge(this, p.parseHTML(o[1], t && t.nodeType ? t.ownerDocument || t : i, !0)), C.test(o[1]) && p.isPlainObject(t)) for (o in t) p.isFunction(this[o]) ? this[o](t[o]) : this.attr(o, t[o]);
                return this
            }
    ...
    p.fn.extend({
        has: function (e) {
            ...
            for (var n, i = 0, o = this.length, r = [], s = w.test(e) || "string" != typeof e ? p(e, t || this.context) : 0; o > i; i++) for (n = this[i]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (s ? s.index(n) > -1 : 1 === n.nodeType && p.find.matchesSelector(n, e))) {
                r.push(n);
                break
            }
    ...
    p.Callbacks = function (e) {
        ...
        var i, o, r, s, a = [], l = [], c = -1, u = function () {
            for (s = e.once, r = i = !0; l.length; c = -1) for (o = l.shift(); ++c < a.length;) !1 === a[c].apply(o[0], o[1]) && e.stopOnFalse && (c = a.length, o = !1);
            ...
            add: function () {
                ...
                return p.each(arguments, function (e, t) {
                    for (var n; (n = p.inArray(t, a, n)) > -1;) a.splice(n, 1), c >= n && c--
                }), this
            }, has: function (e) {
        ...
        Deferred: function (e) {
            ...
            if (a > 1) for (t = new Array(a), n = new Array(a), i = new Array(a); a > r; r++) s[r] && p.isFunction(s[r].promise) ? s[r].promise().progress(u(r, n, t)).done(u(r, i, s)).fail(c.reject) : --l;
    ...
    var R = new H, L = new H, P = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, _ = /[A-Z]/g;

    function q(e, t, n) {
        var i;
        if (void 0 === n && 1 === e.nodeType) if (i = "data-" + t.replace(_, "-$&").toLowerCase(), n = e.getAttribute(i), "string" == typeof n) {
            try {
    ...
    p.extend({
        ...
        queue: function (e, t, n) {
            ...
            t = t || "fx";
            var n = p.queue(e, t), i = n.length, o = n.shift(), r = p._queueHooks(e, t);
    ...
    var F = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, M = new RegExp("^(?:([+-])=|)(" + F + ")([a-z%]*)$", "i"),
        W = ["Top", "Right", "Bottom", "Left"], B = function (e, t) {
    ...
    var z = /^(?:checkbox|radio)$/i, V = /<([\w:-]+)/, Y = /^$|\/(?:java|ecma)script/i, X = {
    ...
    function te(e, t, n, i, o) {
        for (var r, s, a, l, c, u, d = t.createDocumentFragment(), h = [], f = 0, g = e.length; g > f; f++) if (r = e[f], r || 0 === r) if ("object" === p.type(r)) p.merge(h, r.nodeType ? [r] : r); else if (ee.test(r)) {
        ...
        for (d.textContent = "", f = 0; r = h[f++];) if (i && p.inArray(r, i) > -1) o && o.push(r); else if (c = p.contains(r.ownerDocument, r), s = G(d.appendChild(r), "script"), c && J(s), n) for (u = 0; r = s[u++];) Y.test(r.type || "") && n.push(r);
        return d
    }
    ...
    var ne = /^key/, ie = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, oe = /^([^.]*)(?:\.(.+)|)/;
    ...
    p.event = {
        ...
        add: function (e, t, n, i, o) {
            ...
            if (v) for (n.handler && (n = (r = n).handler, o = r.selector), n.guid || (n.guid = p.guid++), (l = v.events) || (l = v.events = {}), (s = v.handle) || (s = v.handle = function (t) {
        ...
        remove: function (e, t, n, i, o) {
            ...
            if (v && (l = v.events)) {
                for (c = (t = (t || "").match(D) || [""]).length; c--;) if (a = oe.exec(t[c]) || [], f = m = a[1], g = (a[2] || "").split(".").sort(), f) {
    ...
    var ce = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, ue = /<script|<style|<link/i,
        de = /checked\s*(?:[^=]|=\s*.checked.)/i, pe = /^true\/(.*)/, he = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    ...
    function ve(e, t) {
        ...
        if (1 === t.nodeType) {
            if (R.hasData(e) && (r = R.access(e), s = R.set(t, r), c = r.events)) {
                ...
                for (o in c) for (n = 0, i = c[o].length; i > n; n++) p.event.add(t, o, c[o][n])
            }
    ...
    function ye(e, t, n, i) {
        t = r.apply([], t);
        var o, s, a, l, c, u, h = 0, f = e.length, g = f - 1, m = t[0], v = p.isFunction(m);
        ...
        if (f && (s = (o = te(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === o.childNodes.length && (o = s), s || i)) {
            ...
            if (l) for (u = a[a.length - 1].ownerDocument, p.map(a, me), h = 0; l > h; h++) c = a[h], Y.test(c.type || "") && !R.access(c, "globalEval") && p.contains(u, c) && (c.src ? p._evalUrl && p._evalUrl(c.src) : p.globalEval(c.textContent.replace(he, "")))
        }
        return e
    }
    ...
    p.extend({
        htmlPrefilter: function (e) {
            ...
            var i, o, r, s, a, l, c, u = e.cloneNode(!0), h = p.contains(e.ownerDocument, e);
            if (!(d.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || p.isXMLDoc(e))) for (s = G(u), r = G(e), i = 0, o = r.length; o > i; i++) a = r[i], l = s[i], void 0, c = l.nodeName.toLowerCase(), "input" === c && z.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (t) if (n) for (r = r || G(e), s = s || G(u), i = 0, o = r.length; o > i; i++) ve(r[i], s[i]); else ve(e, u);
            return (s = G(u, "script")).length > 0 && J(s, !h && G(e, "script")), u
        }, cleanData: function (e) {
            for (var t, n, i, o = p.event.special, r = 0; void 0 !== (n = e[r]); r++) if (Q(n)) {
                if (t = n[R.expando]) {
                    if (t.events) for (i in t.events) o[i] ? p.event.remove(n, i) : p.removeEvent(n, i, t.handle);
                    n[R.expando] = void 0
                }
    ...
    var xe, we = {HTML: "block", BODY: "block"};
    ...
    var Te = /^margin/, je = new RegExp("^(" + F + ")(?!px)[a-z%]+$", "i"), Ee = function (t) {
    ...
    var De = /^(none|table(?!-c[ea]).+)/, Oe = {position: "absolute", visibility: "hidden", display: "block"},
        Ie = {letterSpacing: "0", fontWeight: "400"}, Qe = ["Webkit", "O", "Moz", "ms"],
        He = i.createElement("div").style;

    function Re(e) {
        if (e in He) return e;
        for (var t = e[0].toUpperCase() + e.slice(1), n = Qe.length; n--;) if (e = Qe[n] + t, e in He) return e
    }
    ...
    function _e(e, t, n) {
        var i = !0, o = "width" === t ? e.offsetWidth : e.offsetHeight, r = Ee(e),
    ...
    p.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, r, s, a = p.camelCase(t), l = e.style;
        ...
        p.cssHooks[t] = {
            get: function (e, n, i) {
                ...
                var o, r = i && Ee(e), s = i && Pe(e, t, i, "border-box" === p.css(e, "boxSizing", !1, r), r);
                return s && (o = M.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = p.css(e, t)), Le(0, n, s)
            }
        }
    }), p.cssHooks.marginLeft = $e(d.reliableMarginLeft, function (e, t) {
        return t ? (parseFloat(Ne(e, "marginLeft")) || e.getBoundingClientRect().left - Se(e, {marginLeft: 0}, function () {
            return e.getBoundingClientRect().left
        })) + "px" : void 0
    }), p.cssHooks.marginRight = $e(d.reliableMarginRight, function (e, t) {
        return t ? Se(e, {display: "inline-block"}, Ne, [e, "marginRight"]) : void 0
        ...
        constructor: Fe, init: function (e, t, n, i, o, r) {
    ...
    var Me, We, Be, Ue, ze, Ve = /^(?:toggle|show|hide)$/, Ye = /queueHooks$/;
    ...
    function Je(e, t, n) {
        for (var i, o = (Ke.tweeners[t] || []).concat(Ke.tweeners["*"]), r = 0, s = o.length; s > r; r++) if (i = o[r].call(n, t, e)) return i
    }

    function Ke(e, t, n) {
        var i, o, r = 0, s = Ke.prefilters.length, a = p.Deferred().always(function () {
            delete l.elem
        }), l = function () {
            if (o) return !1;
        ...
        for (function (e, t) {
            var n, i, o, r, s;
            for (n in e) if (i = p.camelCase(n), o = t[i], r = e[n], p.isArray(r) && (o = r[1], r = e[n] = r[0]), n !== i && (e[i] = r, delete e[n]), s = p.cssHooks[i], s && "expand" in s) {
                r = s.expand(r), delete e[i];
                for (n in r) n in e || (e[n] = r[n], t[n] = o)
            } else t[i] = o
        }(u, c.opts.specialEasing); s > r; r++) if (i = Ke.prefilters[r].call(c, e, u, c.opts)) return p.isFunction(i.stop) && (p._queueHooks(c.elem, c.opts.queue).stop = p.proxy(i.stop, i)), i;
    ...
    p.Animation = p.extend(Ke, {
        tweeners: {
            ...
            var i, o, r, s, a, l, c, u = this, d = {}, h = e.style, f = e.nodeType && B(e), g = R.get(e, "fxshow");
            ...
            if (p.isEmptyObject(d)) "inline" === ("none" === c ? ke(e.nodeName) : c) && (h.display = c); else {
        ...
        fadeTo: function (e, t, n, i) {
            ...
            return "string" != typeof e && (n = t, t = e, e = void 0), t && !1 !== e && this.queue(e || "fx", []), this.each(function () {
                var t = !0, o = null != e && e + "queueHooks", r = p.timers, s = R.get(this);
                if (o) s[o] && s[o].stop && i(s[o]); else for (o in s) s[o] && s[o].stop && Ye.test(o) && i(s[o]);
                for (o = r.length; o--;) r[o].elem !== this || null != e && r[o].queue !== e || (r[o].anim.stop(n), t = !1, r.splice(o, 1));
                !t && n || p.dequeue(this, e)
            })
        }, finish: function (e) {
            return !1 !== e && (e = e || "fx"), this.each(function () {
                var t, n = R.get(this), i = n[e + "queue"], o = n[e + "queueHooks"], r = p.timers, s = i ? i.length : 0;
    ...
    p.fn.extend({
        addClass: function (e) {
            ...
            if ("string" == typeof e && e) for (t = e.match(D) || []; n = this[l++];) if (o = ot(n), i = 1 === n.nodeType && (" " + o + " ").replace(it, " ")) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : p.isFunction(e) ? this.each(function (n) {
                ...
                var t, i, o, r;
                if ("string" === n) for (i = 0, o = p(this), r = e.match(D) || []; t = r[i++];) o.hasClass(t) ? o.removeClass(t) : o.addClass(t); else void 0 !== e && "boolean" !== n || (t = ot(this), t && R.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : R.get(this, "__className__") || ""))
            })
        }, hasClass: function (e) {
            var t, n, i = 0;
    ...
    p.fn.extend({
        ...
        valHooks: {
            option: {
                ...
                get: function (e) {
                    for (var t, n, i = e.options, o = e.selectedIndex, r = "select-one" === e.type || 0 > o, s = r ? null : [], a = r ? o + 1 : i.length, l = 0 > o ? a : r ? o : 0; a > l; l++) if (n = i[l], (n.selected || l === o) && (d.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !p.nodeName(n.parentNode, "optgroup"))) {
    ...
    p.extend(p.event, {
        trigger: function (t, n, o, r) {
            var s, a, l, c, d, h, f, g = [o || i], m = u.call(t, "type") ? t.type : t,
            ...
            if (a = l = o = o || i, 3 !== o.nodeType && 8 !== o.nodeType && !at.test(m + p.event.triggered) && (m.indexOf(".") > -1 && (m = (v = m.split(".")).shift(), v.sort()), d = m.indexOf(":") < 0 && "on" + m, (t = t[p.expando] ? t : new p.Event(m, "object" == typeof t && t)).isTrigger = r ? 2 : 3, t.namespace = v.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = o), n = null == n ? [t] : p.makeArray(n, [t]), f = p.event.special[m] || {}, r || !f.trigger || !1 !== f.trigger.apply(o, n))) {
                ...
                for (s = 0; (a = g[s++]) && !t.isPropagationStopped();) t.type = s > 1 ? c : f.bindType || m, h = (R.get(a, "events") || {})[t.type] && R.get(a, "handle"), h && h.apply(a, n), h = d && a[d], h && h.apply && Q(a) && (t.result = h.apply(a, n), !1 === t.result && t.preventDefault());
    ...
    }), d.focusin = "onfocusin" in e, d.focusin || p.each({focus: "focusin", blur: "focusout"}, function (e, t) {
        var n = function (e) {
            p.event.simulate(t, e.target, p.event.fix(e))
        };
        p.event.special[t] = {
            setup: function () {
                var i = this.ownerDocument || this, o = R.access(i, t);
                o || i.addEventListener(e, n, !0), R.access(i, t, (o || 0) + 1)
            }, teardown: function () {
                var i = this.ownerDocument || this, o = R.access(i, t) - 1;
                o ? R.access(i, t, o) : (i.removeEventListener(e, n, !0), R.remove(i, t))
            }
        }
    });
    var lt = e.location, ct = p.now(), ut = /\?/;
    ...
    var dt = /#.*$/, pt = /([?&])_=[^&]*/, ht = /^(.*?):[ \t]*([^\r\n]*)$/gm, ft = /^(?:GET|HEAD)$/, gt = /^\/\//,
        mt = {}, vt = {}, yt = "*/".concat("*"), bt = i.createElement("a");
    ...
    bt.href = lt.href, p.extend({
        ...
        ajax: function (t, n) {
            ...
            var o, r, s, a, l, c, u, d, h = p.ajaxSetup({}, n), f = h.context || h,
                g = h.context && (f.nodeType || f.jquery) ? p(f) : p.event, m = p.Deferred(),
                v = p.Callbacks("once memory"), y = h.statusCode || {}, b = {}, x = {}, w = 0, C = "canceled", k = {
                    readyState: 0, getResponseHeader: function (e) {
                        ...
                        var t;
                        if (e) if (2 > w) for (t in e) y[t] = [y[t], e[t]]; else k.always(e[k.status]);
                        return this
                    }, abort: function (e) {
                        var t = e || C;
            ...
            C = "abort";
            for (d in{success: 1, error: 1, complete: 1}) k[d](h[d]);
            if (o = wt(vt, h, n, k)) {
    ...
    function At(e, t, n, i) {
        ...
        }); else if (n || "object" !== p.type(t)) i(e, t); else for (o in t) At(e + "[" + o + "]", t[o], n, i)
    }
    ...
    var Nt = {0: 200, 1223: 204}, $t = p.ajaxSettings.xhr();
    d.cors = !!$t && "withCredentials" in $t, d.ajax = $t = !!$t, p.ajaxTransport(function (t) {
        ...
        if (e.crossDomain) return {
            send: function (o, r) {
                t = p("<script>").prop({charset: e.scriptCharset, src: e.url}).on("load error", n = function (e) {
...
!function (e) {
    ...
    e.fn.collapse = n, e.fn.collapse.Constructor = i, e.fn.collapse.noConflict = function () {
        ...
        var r = t(o), s = r.data("bs.collapse") ? "toggle" : o.data();
        n.call(r, s)
    })
}(jQuery), function (e) {
    "use strict";
    ...
    t.VERSION = "3.3.7", t.TRANSITION_DURATION = 150, t.DEFAULTS = {
        ...
        var d = /top|bottom/.test(n), p = d ? 2 * u.left - o + l : 2 * u.top - r + c,
    ...
    e.fn.extend({
        slimScroll: function (n) {
            ...
            return this.each(function () {
                ...
                function r(e, t, n) {
                    v = !1;
                    var o = e, r = y.outerHeight() - x.outerHeight();
                    t && (o = parseInt(x.css("top")) + e * parseInt(i.wheelStep) / 100 * x.outerHeight(), o = Math.min(Math.max(o, 0), r), o = 0 < e ? Math.ceil(o) : Math.floor(o), x.css({top: o + "px"})), o = (g = parseInt(x.css("top")) / (y.outerHeight() - x.outerHeight())) * (y[0].scrollHeight - y.outerHeight()), n && (e = (o = e) / y[0].scrollHeight * y.outerHeight(), e = Math.min(Math.max(e, 0), r), x.css({top: e + "px"})), y.scrollTop(o), y.trigger("slimscrolling", ~~o), a(), l()
                }

                function s() {
                    f = Math.max(y.outerHeight() / y[0].scrollHeight * y.outerHeight(), 30), x.css({height: f + "px"});
                ...
                var c, u, d, p, h, f, g, m, v = !1, y = e(this);
                if (y.parent().hasClass(i.wrapperClass)) {
                    var b = y.scrollTop(), x = y.siblings("." + i.barClass), w = y.siblings("." + i.railClass);
                    if (s(), e.isPlainObject(n)) {
                        ...
                        if ("scrollTo" in n) b = parseInt(i.scrollTo); else if ("scrollBy" in n) b += parseInt(i.scrollBy); else if ("destroy" in n) return x.remove(), w.remove(), void y.unwrap();
                        r(b, !1, !0)
                    }
                    ...
                    }), s(), "bottom" === i.start ? (x.css({top: y.outerHeight() - x.outerHeight()}), r(0, !0)) : "top" !== i.start && (r(e(i.start).position().top, null, !0), i.alwaysVisible || x.hide()), window.addEventListener ? (this.addEventListener("DOMMouseScroll", o, !1), this.addEventListener("mousewheel", o, !1)) : document.attachEvent("onmousewheel", o)
                }
            }), this
        }
    ...
    "use strict";
    var t, n = 32, i = 33, o = 34, r = 35, s = 36, a = 38, l = 40, c = function (t, n) {
        var i, o, r = n.scrollTop(), s = n.prop("scrollHeight"), a = n.prop("clientHeight"),
        ...
        var c, u, d = t.scrollTop(), p = {top: !1, bottom: !1};
    ...
    d.NAME = "ScrollLock", d.VERSION = "3.1.2", d.NAMESPACE = ".scrollLock", d.ANIMATION_NAMESPACE = d.NAMESPACE + ".effect", d.DEFAULTS = {
        ...
        keyboardHandler: function (t) {
            var n, i = e(t.currentTarget), o = (i.scrollTop(), u(t, i));
        ...
        return this.each(function () {
            var n = e(this), i = "object" == typeof t && t, o = n.data(d.NAME);
        ...
        return this.each(function () {
            ...
            if (n.appeared = !1, t) {
                var o = e(window), r = function () {
                    if (n.is(":visible")) {
                        var e = o.scrollLeft(), t = o.scrollTop(), r = n.offset(), s = r.left, a = r.top, l = i.accX,
                            c = i.accY, u = n.height(), d = o.height(), p = n.width(), h = o.width();
    ...
    t.DEFAULTS = {
        ...
        return this.each(function () {
            var i = e(this), o = i.data("countTo"), r = "object" == typeof n ? n : {},
    ...
    function t(t, n) {
        var o = e(this);
        if (this.value === o.attr(s ? "placeholder-x" : "placeholder") && o.hasClass(p.customClass)) if (this.value = "", o.removeClass(p.customClass), o.data("placeholder-password")) {
    ...
    function n(n) {
        var i, o, r, a, l = e(this), c = this.id;
        if (!n || "blur" !== n.type || !l.hasClass(p.customClass)) if ("" === this.value) {
            if ("password" === this.type) {
                if (!l.data("placeholder-textinput")) {
                    try {
                        i = l.clone().prop({type: "text"})
                    } catch (t) {
                    ...
                    i.removeAttr("name").data({
                        ...
                        "placeholder-id": c
                    }).bind("focus.placeholder", t), l.data({"placeholder-textinput": i, "placeholder-id": c}).before(i)
                }
    ...
    var o, r, s = !1, a = "[object OperaMini]" === Object.prototype.toString.call(window.operamini),
        l = "placeholder" in document.createElement("input") && !a && !s,
        c = "placeholder" in document.createElement("textarea") && !a && !s, u = e.valHooks, d = e.propHooks, p = {};
    l && c ? ((r = e.fn.placeholder = function () {
        return this
    }).input = !0, r.textarea = !0) : ((r = e.fn.placeholder = function (i) {
        return p = e.extend({}, {customClass: "placeholder"}, i), this.filter((l ? "textarea" : ":input") + "[" + (s ? "placeholder-x" : "placeholder") + "]").not("." + p.customClass).not(":radio, :checkbox, [type=hidden]").bind({
            "focus.placeholder": t,
            "blur.placeholder": n
        ...
        function i(t, o, r) {
            ...
            if ("undefined" != typeof document) {
                ...
                for (var u = document.cookie ? document.cookie.split("; ") : [], d = /(%[0-9A-Z]{2})+/g, p = 0; p < u.length; p++) {
                    var h = u[p].split("="), f = h.slice(1).join("=");
...
var App = function () {
    var e, t, n, i, o, r, s, a, l, c, u = function () {
        ...
        var e = jQuery(window).height(), t = a.outerHeight(), i = c.outerHeight();
        ...
        "init" === e ? (h(), jQuery(window).on("resize orientationchange", function () {
            ...
            railVisible: !1,
            railOpacity: 1
        }) : s.add(s.parent()).css("height", r.outerHeight())) : (jQuery(i).scrollLock("enable"), jQuery(r).scrollLock("enable"), o.length && o.parent(".slimScrollDiv").length && (o.slimScroll({destroy: !0}), o.attr("style", "")), s.length && s.parent(".slimScrollDiv").length && (s.slimScroll({destroy: !0}), s.attr("style", "")))
    }, f = function (e) {
        ...
        var n = "si si-size-fullscreen", i = "si si-size-actual", o = "si si-arrow-up", r = "si si-arrow-down";
        ...
        jQuery('[data-toggle="theme"][data-theme="' + (e.length ? e.attr("href") : "default") + '"]').parent("li").addClass("active"), jQuery('[data-toggle="theme"]').on("click", function () {
            ...
            jQuery('[data-toggle="theme"]').parent("li").removeClass("active"), jQuery('[data-toggle="theme"][data-theme="' + n + '"]').parent("li").addClass("active"), "default" === n ? e.length && e.remove() : e.length ? e.attr("href", n) : jQuery("#css-main").after('<link rel="stylesheet" id="css-theme" href="' + n + '">'), e = jQuery("#css-theme"), t && Cookies.set("colorTheme", n, {expires: 7})
        })
    }, x = function () {
        jQuery('[data-toggle="scroll-to"]').on("click", function () {
            var e = jQuery(this), t = e.data("target"), i = e.data("speed") || 1e3,
                o = a.length && n.hasClass("header-navbar-fixed") ? a.outerHeight() : 0;
            jQuery("html, body").animate({scrollTop: jQuery(t).offset().top - o}, i)
        })
    }, w = function () {
        ...
        var e = new Date, t = jQuery(".js-year-copy"),
    ...
    return {
        init: function (e) {
            ...
            switch (t) {
                ...
                case"notify":
                    jQuery(".js-notify").on("click", function () {
                        ...
                        jQuery.notify({
                            ...
                            newest_on_top: !0,
                            showProgressbar: !1,
                            placement: {from: e.data("notify-from") || "top", align: e.data("notify-align") || "right"},
                            offset: 20,
                            spacing: 10,
                            z_index: 1033,
                            delay: 5e3,
                ...
                case"rangeslider":
                    jQuery(".js-rangeslider").each(function () {
                        jQuery(this).ionRangeSlider({input_values_separator: ";"})
                    });
                    break;
                case"simplemde":
                    jQuery(".js-simplemde").each(function () {
                        var e = jQuery(this);
                        new SimpleMDE({element: e[0]})
                    });
                    break;
                case"masonry":
                    !function () {
            ...
            if (e instanceof Array) for (var t in e) App.initHelper(e[t]); else App.initHelper(e)
        }
    }
}(), OneUI = App;
jQuery(function () {
